...
const LANG_DATA = {
  ...
  en: {
    ...
    facts: [
      'Norwegians eat around 3 million hot dogs on May 17th alone!',
      'Norway\'s Constitution was signed at Eidsvoll Building on May 17, 1814.',
      'Oslo\'s children\'s parade is the longest of its kind in the world!',
      'The Bunad is the traditional outfit proudly worn on Norway\'s National Day.',
      'The Norwegian flag was officially adopted in 1821 and designed by Fredrik Meltzer.',
      'Every year, the King greets the children\'s parade from the balcony of the Royal Palace.',
    ],
  },
};
...
const NPC_DATA = [
  {
    ...
    lines: [
      ...
      'Eg elsker 17. mai. Det er noke heilt eige med akkurat denne dagen.',
      'Visste du at den norske grunnlova er den eldste i Europa som framleis er i bruk?',
    ],
    linesEn: [
      'Hi! Happy Constitution Day!',
      'I love May 17th. There\'s something special about this day.',
  ...
  },
  {
    ...
    lines: [
      ...
      'Lompe, sennep, ketchup. Nokre gangar litt reker også. Ikkje døm meg.',
      'Fun fact: vi eter rundt om 3 millioner pølser bare på denne eine dagen!',
    ],
    linesEn: [
      '*chewing* Hey! Want a hot dog? Strongly recommend.',
      'Potato flatbread, mustard, ketchup. Sometimes a little shrimp too. Don\'t judge.',
      'Fun fact: Norwegians eat around 3 million hot dogs on this single day alone!',
    ],
  },
  {
    id: 'nora', name: 'Nora',
    ...
    linesEn: [
      ...
      'I don\'t understand people who want flatbread with their hot dog. Just bread, please.',
      'Emma thinks I have bad taste. She\'s wrong, of course...',
    ],
  },
  {
    id: 'emma', name: 'Emma',
    ...
    activity: 'is',
    lines: [
      'Hei! Emma her. Nora er søstera mi, om du ikkje alt har skjønt det.',
      'Vi er alltid sammen på 17. mai. Hadde vore rart å ikkje gjøre det!',
      'Visste du at Grunnlova ble signert 17. mai 1814? Vi har feira i over 210 år!',
    ],
    linesEn: [
      'Hi! Emma here. Nora is my sister, in case that wasn\'t already obvious.',
      'We always spend May 17th together. It would be weird not to!',
      'Did you know that The Norwegian Constitution was signed May 17, 1814? We have been celebrating for over 210 years!',
    ],
  },
  {
    id: 'aksel', name: 'Aksel',
    ...
    lines: [
      ...
      'Ingen dag i heile året slår 17. mai. Det er berre fakta.',
      'Viste du at det norske flagget ble offisielt vedtatt i 1821? Designet av Fredrik Meltzer!',
    ],
    linesEn: [
      'NORWAY! NORWAY! NORWAY! Happy Constitution Day!',
      'No day in the whole year beats May 17th. Just facts.',
